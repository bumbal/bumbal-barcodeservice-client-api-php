...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://barcode-shared-service.bumbal.eu/api';
    ...
    {
        $report  = 'PHP SDK (BarcodeService) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://barcode-shared-service.bumbal.eu/api",
                "description" => "Barcode shared service remote access",
            ],
            [
                "url" => "barcode-shared-service/api",
                "description" => "barcodes local access",
            ]
        ];
    }
